        ...
        <div className='flex flex-col md:flex-row'>
          ...
          <div className='md:w-1/2 mt-12 md:mt-24 space-y-2 order-2 md:order-1'>
            ...
            <p className='text-sm md:text-md text-justify'>
              I am a skilled web developer with experience in designing and building responsive, user-friendly websites.
              I specialize in front-end and/or back-end development (mention your expertise), with proficiency in technologies
              like HTML, CSS, JavaScript, and frameworks/libraries such as React.
              I enjoy creating seamless web experiences and solving complex coding challenges.
            </p>

            <br />

            {/* SOCIAL + WORKING SECTION */}
